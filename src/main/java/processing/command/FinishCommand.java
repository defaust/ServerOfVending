...
public class FinishCommand extends AbstractCommand {
    ...
    public FinishCommand(DataBase dataBase){
    ...
    @Override
    public String perform() throws NetExceptionClose {

        System.out.println("Performed command FINISH");

        throw new NetExceptionClose("0|Finish command");
    }
